# genpark-modular-b2b-procurement-marketplace-portal-skill
...
> **GenPark AI Agent Skill** -- Modular B2B procurement marketplace portal with cXML PunchOut (DJUST style)
